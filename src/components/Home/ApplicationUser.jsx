...
export default function ApplicationUser() {
    ...
    return (
        <div>
            <div className="footerApp" id='application-users'>
                <div className="imgApp relative ">
                    <img src="http://demo1.cybersoft.edu.vn/static/media/backapp.b46ef3a1.jpg" alt="hinhAPP"
                        style={{
                            width: '100%',
                           height: '700px',
                        }} />
                </div>
                <div className="contentApp flex absolute gap-9"
                    style={{
                        top: '3165px',
                        right: '480px',
                    }}
                >
                    <div className="contentDesc mr-16">
                        ...
                        >Không chỉ đặt vé, bạn còn có thể bình luận phim, chấm điểm
                            <br />
                            rạp và đổi quà hấp dẫn.</p>
                        <Button className="bg-red-600 text-white py-8 relative"
                            style={{
                                width: '88%',
                                marginTop: '22px',
                            }}>
